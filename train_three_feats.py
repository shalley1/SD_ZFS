...
"""
File: Train Model on three features
Description: This script trains a Q-network on the ZFS problem. Three features used:  if a node is blue and if a node is already selected in the initial set, and clustering coef. of a node 
Usage:
